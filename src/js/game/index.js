;(function() {
	...
	class Placement {
		...
		onMouseMove(e) {
			...
			// клон находится в пределах игрового поля, с учётом погрешности
	...
	*/
	...
	buttonPlay.addEventListener('click', function(e) {
		...
		toptext.innerHTML = 'Морской бой между эскадрами человека и ржавой машины!!!';
